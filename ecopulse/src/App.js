...
export default function Example() {
  ...
  return (
    ...
    <div>
      ...
      <><p>          Tell us about yourself, explain what type of investments you are looking for
              </p><p className='text-grey-400'> (e.g. Im a young investor looking to make big profit, I have a large amount of money to invest and am willing to try anything for a big profit margin and need a return within the next 10 years)</p></>
      </label>
      ...
      <label className="block mx-40 text-md mt-20 leading-6 text-dark-green">
      <><p>          Tell us more about the type of ideas you want to invest in?
              </p><p className='text-grey-400'> (e.g. i.e. are you interested in a certain sector (Education), businesss model etc.)</p></>
      </label>
      <div className="mx-40 mt-2">
        <input
